...
async function createSampleDataSimple() {
  try {
    console.log('🚀 Starting simple sample data creation...');
    ...
    console.log('2. Create auth users for the emails listed above');
    console.log('3. Set passwords for each user');
    console.log('4. Test the system with different user roles');
    
  } catch (error) {
    console.error('❌ Error creating simple sample data:', error);
    throw error;
  } finally {
    await client.end();
  }
